...
class EscolasControllerTest < ActionController::TestCase
  ...
  test "should create escola" do
    assert_difference('Escola.count') do
      post :create, escola: { email_do_dono: @escola.email_do_dono, nome: @escola.nome, pitch: @escola.pitch, subdominio: @escola.subdominio }
    end
  ...
  test "should update escola" do
    patch :update, id: @escola, escola: { email_do_dono: @escola.email_do_dono, nome: @escola.nome, pitch: @escola.pitch, subdominio: @escola.subdominio }
    assert_redirected_to escola_path(assigns(:escola))
  end
