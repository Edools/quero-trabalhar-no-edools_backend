...
class EnrollmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post enrollments_url, params: { enrollment: { school_id: @enrollment.school_id, status: @enrollment.status, student_id: @enrollment.student_id } }
    end
  ...
  test "should update enrollment" do
    patch enrollment_url(@enrollment), params: { enrollment: { school_id: @enrollment.school_id, status: @enrollment.status, student_id: @enrollment.student_id } }
